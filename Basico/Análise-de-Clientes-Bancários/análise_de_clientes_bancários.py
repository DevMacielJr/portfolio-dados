...
Original file is located at
    https://colab.research.google.com/drive/1n9da4PFr6XP7eASNQFJ_tQDyNguOCE01
...
tabela = pd.read_csv("/content/drive/MyDrive/Cursos/Analise-de-Dados/ClientesBanco.csv", encoding="latin1")
